...
import type { MigrationProjectMap, MigrationSource } from '../../../shared/types/migration.js';
...
export const migrationJourneys = pgTable('migration_journeys', {
  ...
  projectMap: jsonb('project_map').$type<MigrationProjectMap>().notNull(), destinations: jsonb('destinations').notNull().default({}),
