          ...
          <main className={workbench ? '' : 'mx-auto max-w-3xl px-4 py-8'}>
            ...
            <Routes>
              ...
              {/* The Work surface is gone — every part of it had a better home.
                  Cards that need you are on Today (where they already were),
                  work in motion is live in its thread, and what finished is on
                  the Record and the project's own history. A bookmark lands on
                  the front door rather than on nothing. */}
